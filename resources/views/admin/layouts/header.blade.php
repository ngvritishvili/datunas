            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item dropdown"><a id="messages" rel="nofollow" data-target="#" href="#"
                                ...
                                class="badge bg-orange badge-corner">0</span></a>
                        <ul aria-labelledby="notifications" class="dropdown-menu">
{{--                            @foreach( \App\Contact::where('read', 1)->paginate(4) as $one)--}}
                                <li><a rel="nofollow" href="#" class="dropdown-item d-flex">
                                        ...
                                        <div class="msg-body">
                                            <h3 class="h5">123</h3><span>Sent You Message</span>
                                        </div>
                                    </a>
                                </li>
{{--                            @endforeach--}}
                            ...
                            {{--                                            </li>--}}
                            <li>
                                <a rel="nofollow" href="{{ route('contact.index', app()->getLocale() ) }}"
    ...
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            <li class="{{ (request()->is('admin/' . app()->getLocale() )) ? 'active' : '' }}"><a
                    href="{{ route('dashboard', app()->getLocale() ) }}"> <i
                        class="icon-home"></i>Home
                </a></li>
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/sms*')) ? 'active' : '' }}"><a
                    href="{{ route('sms.index') }}"> <i
                        class="icon-screen"></i>SMS
                </a>
            </li>
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/clients*')) ? 'active' : '' }}"><a
                    href="{{ route('clients.index') }}"> <i
                        class="icon-screen"></i>Clients
                </a>
            </li>
            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/products*')) ? 'active' : '' }}"><a
                    href="{{ route('products.index', app()->getLocale() ) }}"> <i
                        class="icon-interface-windows"></i>Products
                </a>
            </li>
{{--            <li class="{{ (request()->is('admin/'. app()->getLocale() .'/contact*')) ? 'active' : '' }} "><a--}}
{{--                    href="{{ route('contact.index', app()->getLocale() ) }}"> <i--}}
{{--                        class="icon-mail"></i>123--}}
{{--                </a>--}}
{{--            </li>--}}
